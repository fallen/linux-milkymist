...
#define CSR_PFPU_CTL		(0x80005000)
#define PFPU_CTL_START		0x01
#define PFPU_CTL_BUSY		0x01

#define CSR_PFPU_MESHBASE	(0x80005004)
#define CSR_PFPU_HMESHLAST	(0x80005008)
#define CSR_PFPU_VMESHLAST	(0x8000500C)

#define CSR_PFPU_CODEPAGE	(0x80005010)

#define CSR_PFPU_VERTICES	(0x80005014)
#define CSR_PFPU_COLLISIONS	(0x80005018)
#define CSR_PFPU_STRAYWRITES	(0x8000501C)
#define CSR_PFPU_LASTDMA	(0x80005020)
#define CSR_PFPU_PC		(0x80005024)
